...
namespace HRUTWeb
{
    class Describer
    {
        ...
        public static string DescribEmoji(FaceBase face)
        {
            ...
            string path = Path.Combine(Global.ServerRoot, sb.ToString());
            sb.Append(DirectoryHelper.RandomFile(path));
            sb.Append(".png");
            return Path.Combine(Global.ServerRoot, sb.ToString());
        }
        ...
        public static string Avatar(FaceBase face)
        {
            ...
            path.Append(".png");
            return Path.Combine(Global.ServerRoot, path.ToString());
        }
    }
}
